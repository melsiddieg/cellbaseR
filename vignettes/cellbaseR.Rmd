...
library(cellbaseR)
cb <- CellBaseR()
sp <- getMeta(object = cb, resource = "species")
...
library(cellbaseR)
cb <- CellBaseR()
res <- getRegion(object=cb,ids="17:1000000-1100000",
resource="clinical")
# to get all conservation data in this region
res <- getRegion(object=cb,ids="17:1000000-1100000",
resource="conservation")
#likewise to get all the regulatory data for the same region
res <- getRegion(object=cb,ids="17:1000000-1100000", resource="regulatory")
str(res,1)
```
### cbVraiantClient 
...
samples(header(vcf))
geno(header(vcf))
length(rowRanges(vcf))==length(res)
str(res,1)
