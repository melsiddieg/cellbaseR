...
# Getting help with cellbaseR queries
cellbaseR Also provides a quick method to get information about the avaiable
resources for any particular CellBaseR method, eg, getGene, getProtein, etc, 
through getCellBaseResourceHelp. 
```{r}
library(cellbaseR)
cb <- CellBaseR()
