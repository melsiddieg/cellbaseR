...
#' obtain a wealth of biological information from a single database saving a 
#' lot of time. Another benefit is that researchers can easily make  queries
#' about different biological topics and link all this information together as
